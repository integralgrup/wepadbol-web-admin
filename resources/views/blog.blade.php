                            ...
                            <div class="swiper-wrapper">
                                <?php foreach ($blogs as $key => $item) : ?>
                                    <div class="swiper-slide overflow-hidden" dir="ltr">
                                        ...
                                        <p class="expo text-[#52555C] text-[18px] font-normal leading-[28px] opacity-65 mb-[40px] lg:mb-[15px] lg:text-base md:[&>_br]:hidden" data-swiper-parallax-x="50%">{{ striptags(mb_substr($item->description, 0, 300)) }}...</p>
