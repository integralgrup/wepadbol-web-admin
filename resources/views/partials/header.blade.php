...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/style.css?v=123456') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/tailwind.css?id=1234567') }}">
        ...
        <div class="menu-wrapper h-full flex items-center gap-[50px] py-[30px] px-[50px] border border-solid border-white/20 bg-white/4 backdrop-blur-[10px] rounded-[8px] duration-350 group-[&.is-fixed]/header:backdrop-blur-0 group-[&.is-fixed]/header:bg-white/0 group-[&.is-fixed]/header:border-white/0 lg:hidden xl:p-[15px] xl:gap-[15px]">
                ...
                <?php foreach ($menuList as $key => $item) : ?>
                    <li class="page-item group/menu">
                        ...
                        <?php if (!empty($item['submenu']) && $item['submenu'] == 'submenu-1') : ?>
                            <div class="sub-menu-wrapper absolute top-full left-[120px] translate-x-full opacity-0 invisible pointer-events-none ease-in-out duration-350 group-hover/menu:opacity-100 group-hover/menu:pointer-events-auto group-hover/menu:visible group-hover/menu:translate-x-0 xl:left-[-150px]">
            ...
            <ul class="menu h-full flex items-center gap-[50px] 2xl:gap-[30px] xl:gap-[20px]">
                <?php foreach ($menuList as $key => $item): ?>
                    <li class="page-item group/menu">
                        <a href="<?= $item['url'] ?>"
                            class="group/a peer w-full flex justify-center items-center gap-[10px] bg-transparent rounded-[8px] p-[15px] duration-350 group-hover/menu:bg-[#D9D9D9]/25 group-[&.is-active]/menu:!bg-green">
                            <div
                                class="page text-white opacity-85 text-[20px] leading-[28px] group-[&.is-fixed]/header:text-blue group-[&.blue]/header:text-blue group-[&.blue]/header:group-[&.is-active]/menu:text-white group-[&.blue]/header:opacity-100 group-[&.is-fixed]/header:group-[&.is-active]/menu:text-white group-[&.is-fixed]/header:opacity-100">
                                <?= $item['title'] ?>
                            </div>
                            <?php if (isset($item['submenu'])): ?>
                                <i class="icon icon-chevron-down text-white opacity-25 text-[9px] h-[9px] leading-normal flex duration-350 group-[&.is-fixed]/header:text-blue group-[&.blue]/header:group-[&.is-active]/menu:text-white group-[&.blue]/header:text-blue group-hover/menu:opacity-100 group-[&.is-fixed]/header:group-[&.is-active]/menu:text-white group-[&.is-active]/menu:-rotate-180 group-[&.is-active]/menu:opacity-100"></i>
                        ...
                        <?php if (!empty($item['submenu']) && $item['submenu'] == 'submenu-1'): ?>
                            <div
                                class="sub-menu-wrapper absolute top-full left-[120px] translate-x-full opacity-0 invisible pointer-events-none ease-in-out duration-350 group-hover/menu:opacity-100 group-hover/menu:pointer-events-auto group-hover/menu:visible group-hover/menu:translate-x-0 xl:left-[-150px]">
                                <div class="pt-[40px] -translate-y-[20px]">
                                    <div
                                        class="sub-menu [background:_linear-gradient(180deg,_#FFF_0%,_#FFF_100%);] px-[90px] py-[70px] rounded-l-[16px] min-w-[1215px] w-full h-[670px] [filter:_drop-shadow(0px_10px_40px_rgba(3,_36,_107,_0.15));]  xl:h-[630px]">
                                        <div
                                            ...
                                            <div class="image-field relative flex flex-col items-end">
                                                ...
                                                <!-- SHAPES -->
                                                <div
                                                    class="triangle-shape drag-anim cursor-pointer absolute left-[460px] top-[10px] w-[127px] h-[127px]">
                                                    <img src="../assets/svg/triangle.svg" alt=""
                                                        class="size-full object-cover object-center">
                                                </div>
                                                <div
                                                    class="rectangle-shape drag-anim cursor-pointer absolute left-[460px] bottom-0 w-[100px] h-[100px]">
                                                    <img src="../assets/svg/rectangle.svg" alt=""
                                                        class="size-full object-cover object-center">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt-[40px] -translate-y-[20px]">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="pages-field flex flex-col gap-[50px] justify-center">
                                                    <div
                                                        class="header-content-carousel-hover swiper max-h-[450px] size-full pl-[30px]">
                                                        <div class="swiper-wrapper">
                                                            <!-- EN AZ 6 ADET OLACAK FOREACH YAPILMALI -->
                                                            <?php foreach ($item['mega'] as $key => $item): ?>
                                                                <div
                                                                    class="swiper-slide group/slide -z-2 [&.swiper-slide-active]:z-10">
                                                                    <a href="padel-clubs.php"
                                                                        class="title text-[#98A2B7] text-[32px] font-normal leading-[48px] relative cursor-pointer before:absolute before:left-[-30px] before:top-[50%] before:translate-y-[-50%] rtl:before:right-[10px] rtl:pr-[30px] before:w-[12px] before:h-[12px] before:bg-[#98A2B7] before:duration-350 duration-350  group-hover/slide:before:bg-green group-hover/slide:text-green"><?= $item['title'] ?></a>
                                                                </div>
                                                            <?php endforeach; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- IMAGES -->
                                                <?php $list = ['image-1.jpg', 'image-2.jpg', 'image-3.jpg', 'image-1.jpg', 'image-2.jpg', 'image-3.jpg',]; ?>
                                                <div class="image-field-hover relative flex flex-col items-end">
                                                    <div class="header-image-carousel swiper max-h-[530px] size-full">
                                                        <div class="swiper-wrapper">
                                                            <!-- EN AZ 6 ADET OLACAK FOREACH YAPILMALI -->
                                                            <?php foreach ($list as $key => $item): ?>
                                                                <div
                                                                    class="swiper-slide group/slide duration-350 [&.swiper-slide-active]:z-10">
                                                                    <div
                                                                        class="image w-full ml-auto max-w-[260px] h-[205px] aspect-[13/10] blur-[3.5px] opacity-0 overflow-hidden rounded-[16px] duration-350
                                                          group-[&.swiper-slide-prev]/slide:opacity-100 group-[&.swiper-slide-prev]/slide:mt-[5px]
                                                          group-[&.swiper-slide-next]/slide:opacity-100 group-[&.swiper-slide-next]/slide:mt-[-50px]
                                                          group-[&.swiper-slide-active]/slide:opacity-100 group-[&.swiper-slide-active]/slide:scale-y-[1.75] group-[&.swiper-slide-active]/slide:blur-0 group-[&.swiper-slide-active]/slide:mr-[240px] group-[&.swiper-slide-active]/slide:mt-[-50px] group-[&.swiper-slide-active]/slide:scale-x-[1.75] xl:h-[175px]">
                                                                        <img src="../assets/image/jpg/<?= $item ?>"
                                                                            alt="<?= $item ?>"
                                                                            class="size-full object-cover object-center">
                                                                    </div>
                                                                </div>
