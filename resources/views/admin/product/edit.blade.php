                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                              ...
                                              <textarea class="form-control" id="features_description_{{ $language->lang_code }}" name="features_description_{{ $language->lang_code }}" rows="3" required>{{ $features_description[$language->lang_code] ?? '' }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                              ...
                                              <textarea class="form-control" id="technical_info_{{ $language->lang_code }}" name="technical_info_{{ $language->lang_code }}" rows="3" required>{{ $technical_info[$language->lang_code] ?? '' }}</textarea>
                                        </div>
                                        <div></div>
                                        <!-- pdf file --> 
                                        <div class="mb-3">
